...
session_start();
 $photo=mysqli_query($con,"select * from arts where arttype='photograph'");
?>
<html>
<head>
<style>
...
table{width:100%;}
.bg{background-color:white;height:100%;}
</style>
</head>
<body>
<h1>PHOTOGRAPHS</h1>
...
<form action="../order.php" method="POST">
	...
	<input type="hidden" name="arttype" value=<?php echo $row["Arttype"],'>';if($_SESSION['username']!=$row['Name']){ 
	echo '<input type ="submit" value ="order now"></form>';}else{echo"Its Your art! not sold</p></td>";}
   }}
